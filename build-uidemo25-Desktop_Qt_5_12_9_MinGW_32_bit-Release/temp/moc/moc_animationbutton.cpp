...
#include "../../../uidemo/api/animationbutton.h"
...
QT_MOC_LITERAL(3, 25, 17), // "enterImageChanged"
QT_MOC_LITERAL(4, 43, 5), // "index"
QT_MOC_LITERAL(5, 49, 17) // "leaveImageChanged"

    },
    "AnimationButton\0Clicked\0\0enterImageChanged\0"
    "index\0leaveImageChanged"
};
...
void AnimationButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<AnimationButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject AnimationButton::staticMetaObject = { {
    ...
    qt_meta_stringdata_AnimationButton.data,
    qt_meta_data_AnimationButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
