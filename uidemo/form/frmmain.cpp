...
void frmMain::initForm()
{
    ...
    //设置底部状态栏
    ui->bottomWidget->setVersion("V20230217");
...
{
    //从配置文件读取logo名称
    ui->labLogoCn->setText("高压储能电池管理平台");
    ui->labLogoEn->setText("battery management system");
    this->setWindowTitle(ui->labLogoCn->text());

    //设置标题+版本+版权
    ui->bottomWidget->setTitle("高压储能电池管理平台");
    ui->bottomWidget->setAuthor("宁德市思瑞信息科技有限公司");
}
