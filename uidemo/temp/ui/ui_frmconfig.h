...
public:
    ...
    void setupUi(QWidget *frmConfig)
    {
        ...
        btn_batery_Real_time = new QPushButton(widgetLeft);
        btn_batery_Real_time->setObjectName(QString::fromUtf8("btnConfigSystem"));

        verticalLayout->addWidget(btn_batery_Real_time);
    ...
    void retranslateUi(QWidget *frmConfig)
    {
        ...
        btn_batery_Real_time->setText(QString());
